...
function calculateLoan() {
    ...
    document.querySelector('#emi').innerText = 'Equated Monthly Instalment: ' + emi.toFixed(2);
    document.querySelector('#totalAmount').innerText = 'Total Amount To Be Paid: ' + totalAmount.toFixed(2);
